...
><result column="user_id" property="userId"></result>
>
>将数据库种的列名 `user_id` 和我们自定义的实体类种的属性名`userId`关联
...
![image-2](https://kinvy-images.oss-cn-beijing.aliyuncs.com/Images/image-2.png)
...
![image-20210224164927461](https://kinvy-images.oss-cn-beijing.aliyuncs.com/Images/image-4.png)
...
![image-20210224170108202](https://kinvy-images.oss-cn-beijing.aliyuncs.com/Images/image-5.png)
